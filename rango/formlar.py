...
class KategoriForm(forms.ModelForm):
    kategoriIsim = forms.CharField(max_length=128,help_text="Bir kategori ismi belirleyiniz:")
...
class SayfaForm(forms.ModelForm):
    sayfaIsim = forms.CharField(max_length=128,help_text="Eklencek sayfa ismini giriniz:")
    sayfaGoruntuleme = forms.IntegerField(widget=forms.HiddenInput(),initial=0)
    sayfaUrl = forms.URLField(max_length=200,help_text="Sayfa adresini giriniz:")
    def clean(self):
